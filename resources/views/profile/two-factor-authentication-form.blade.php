<x-profile-settings-card>
	...
	@else
		...
		<div class="uk-flex uk-flex-middle uk-visible@s">
			<div class="hidden-recovery-codes" @unless(session('status')=='two-factor-authentication-enabled' )hidden
				@endunless>
			...
			<button type="submit"
				...
				uk-toggle="target: .hidden-recovery-codes" @if(session('status')=='two-factor-authentication-enabled' ) hidden
				@endif>
