        ...
        <div class="uk-margin uk-width-large">
            ...
            <div class="uk-width-1-1">
                <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input @error('name', 'updateProfileInformation') uk-form-danger @enderror"
                        type="text" name="name" value="{{ old('name') ?? auth()->user()->name }}" required autofocus
                        autocomplete="name" />
                </div>
        ...
        <div class="uk-margin uk-width-large">
            ...
            <div class="uk-width-1-1">
                <div class="uk-inline uk-width-1-1">
                    ...
                    <input class="uk-input @error('email', 'updateProfileInformation') uk-form-danger @enderror"
